...
![Raft状态转换](./raft角色转换.jpg "Raft中节点状态转换")
...
![Raft日志被覆盖](./raft已提交的日志被覆盖.jpg "日志被覆盖")
...
![Raft成员变更](./raft成员变更.png "成员变更复杂情况")
...
![Raft成员变更](./raft两阶段成员变更.png "成员变更两个阶段")
